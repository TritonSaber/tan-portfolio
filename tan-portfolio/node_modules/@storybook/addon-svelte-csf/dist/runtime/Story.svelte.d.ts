...
declare function $$render<TArgs extends Record<string, any>, TCmp extends Cmp, TChildren extends Snippet = Snippet>(): {
...
declare class __sveltets_Render<TArgs extends Record<string, any>, TCmp extends Cmp, TChildren extends Snippet = Snippet> {
    props(): ReturnType<typeof $$render<TArgs, TCmp, TChildren>>['props'];
    events(): ReturnType<typeof $$render<TArgs, TCmp, TChildren>>['events'];
    slots(): ReturnType<typeof $$render<TArgs, TCmp, TChildren>>['slots'];
    bindings(): "";
    exports(): {};
}
